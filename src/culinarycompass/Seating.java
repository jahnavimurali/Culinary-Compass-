 ...
 * @author JAHNAVI
 */
public class Seating extends javax.swing.JPanel {
    Connection con;
    Statement st;
    ...
    public void tb_load(){
        try{
            DefaultTableModel dt = (DefaultTableModel)Seating_Table.getModel();
            dt.setRowCount(0);
            st=db.mycon().createStatement();
            rs=st.executeQuery("SELECT * from Seating");
    ...
    private void initComponents() {
        ...
        tb_cap = new javax.swing.JTextField();
        tb_feature = new javax.swing.JTextField();
        tb_waiterid = new javax.swing.JTextField();
        ...
        Seating_Table = new javax.swing.JTable();
        ...
        tb_cap.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tb_cap.setText("0");

        tb_feature.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tb_feature.setText("0");

        tb_waiterid.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tb_waiterid.setText("0");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tb_cap, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tb_feature, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tb_waiterid, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(Insert)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(TABLE_CAP)
                    .addComponent(tb_cap, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(TABLE_FEATURE)
                    .addComponent(tb_feature, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tb_waiterid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(WAITER_ID))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Search)
        ...
        Seating_Table.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.white, java.awt.Color.lightGray));
        Seating_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Table_ID", "Capacity", "Table_Feature", "Waiter_ID"
            }
        ));
        Seating_Table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Seating_TableMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(Seating_Table);
        ...
        jLabel8.setText("Seating Information");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
        ...
        String value2 = tb_cap.getText();
        String value3 = tb_feature.getText();
        String value4 = tb_waiterid.getText();
        
        try  {
            String sql = "INSERT INTO Seating (Table_ID, Capacity, Table_feature, Waiter_id) VALUES (?, ?, ?, ?)";
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
        String sql = "select * from seating where table_id = '"+search_tb_id.getText()+"'";
        st = db.mycon().createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
        rs = st.executeQuery(sql);
        if(rs.next()){
        tb_id.setText(rs.getString(1));
        tb_cap.setText(rs.getString(2));
        tb_feature.setText(rs.getString(3));
        tb_waiterid.setText(rs.getString(4));
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        try{
            ...
            */
            String sql="UPDATE Seating SET Capacity='"+value2+"', Table_Feature='"+value3+"',Waiter_ID='"+value4+"'";
            st.executeQuery(sql);
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        try{
            st = db.mycon().createStatement();
            String sql ="DELETE FROM Seating WHERE table_id='"+value1+"'";
            st.executeQuery(sql);
    ...
    private void Seating_TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Seating_TableMouseClicked
        // mouse click & get values from table to textfield
        int r = Seating_Table.getSelectedRow();
        
        String value1= Seating_Table.getValueAt(r, 0).toString();
        String value2= Seating_Table.getValueAt(r, 1).toString();
        String value3= Seating_Table.getValueAt(r, 2).toString();
        String value4= Seating_Table.getValueAt(r, 3).toString();
        
        
        search_tb_id.setText(value1);
        tb_id.setText(value1);
        tb_cap.setText(value2);
        tb_feature.setText(value3);
        tb_waiterid.setText(value4);
       
    }//GEN-LAST:event_Seating_TableMouseClicked
    ...
    private javax.swing.JTable Seating_Table;
    ...
    private javax.swing.JTextField tb_cap;
    private javax.swing.JTextField tb_feature;
    private javax.swing.JTextField tb_id;
    private javax.swing.JTextField tb_waiterid;
